...
export interface BaseMonthRangeInputProps extends Omit<BaseDateRangeInputProps, 'value' | 'onChange' | 'maxDate' | 'minDate'> {
    /**
...
export declare function BaseMonthRangeInput(props: BaseMonthRangeInputProps): JSX.Element;
export declare namespace BaseMonthRangeInput {
    var defaultProps: Partial<BaseMonthRangeInputProps>;
}
